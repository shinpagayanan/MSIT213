...
from .views import DashboardView, AssetListView, AssetCreateView, SignUpView, MaintenanceCreateView,AssetUpdateView, AssetDeleteView, AssetHistoryView, AssetRevertView
